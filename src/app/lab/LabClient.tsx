...
export default function LabClient({ articles }: { articles: A[] }) {
  ...
  return (
    <div>
      <PageHero num="04 · Lab" title="Le Lab" subtitle="Modélisation 3D, simulateurs et outils de calcul" color={dash.opal} image="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1400&h=400&fit=crop" />
