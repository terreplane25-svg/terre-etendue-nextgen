      ...
      <div className="max-w-5xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div className="flex items-center gap-4 mb-4">
            <span className="font-mono text-label uppercase text-accent-cyan/50">Pilier 01</span>
            <div className="h-px flex-1 bg-white/[0.04]" />
          </div>
          <h1 className="font-display text-title-lg font-bold text-[#E8E4DD] mb-3">
            Le Q.G. <span className="text-accent-cyan">&mdash;</span> <span className="text-[#E8E4DD]/50 font-heading font-normal text-2xl">\u00c9pist\u00e9mologie</span>
          </h1>
          <p className="text-[#E8E4DD]/35 text-lg max-w-2xl font-body leading-relaxed mb-10">
            Fondements m\u00e9thodologiques de la recherche. Comment articuler science empirique et sources sacr\u00e9es sans confondre les registres.
          </p>
        </motion.div>
