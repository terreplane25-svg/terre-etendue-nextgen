    ...
    <div className="absolute top-4 left-4 bg-surface/90 backdrop-blur border border-white/[0.06] rounded-lg p-4 space-y-4 z-10">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full h-1 bg-white/[0.06] rounded-lg appearance-none cursor-pointer accent-[var(--gold)]"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className="w-full h-1 bg-white/[0.06] rounded-lg appearance-none cursor-pointer accent-[var(--cyan)]"
        />
      </div>
    </div>
  );
