...
function getStats() {
  ...
  return [
    { label: 'Articles', value: String(articles.length), color: 'text-[var(--cyan)]' },
    { label: 'Observations', value: '11K', color: 'text-[var(--cyan)]' },
    { label: 'Sources', value: '450+', color: 'text-[var(--gold)]' },
    { label: 'Modèles 3D', value: '3', color: 'text-[var(--cyan)]' },
  ];
}
...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-[var(--panel-edge)] bg-[var(--hull)]">
