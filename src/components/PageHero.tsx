  ...
  return (
    <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.7 }}
      ...
      <div style={{ position: 'relative', maxWidth: 1200, margin: '0 auto', padding: '0 24px 32px', width: '100%' }}>
        <h1 style={{ fontSize: 34, fontWeight: 800, color: '#fff', textShadow: '0 2px 12px rgba(0,0,0,0.4)', marginBottom: 6, lineHeight: 1.2 }}>{title}</h1>
        <p style={{ fontSize: 15, color: dash.inkSoft, textShadow: '0 1px 6px rgba(0,0,0,0.25)' }}>{subtitle}</p>
      </div>
    </motion.section>
  );
}
