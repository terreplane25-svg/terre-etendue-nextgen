...
/home/claude/outils-verification/rapport_selection_site3.md pour le rapport
...
#
# Repris à l'identique des cas précédents — pour que ce dossier reste autonome et rejouable sans
# dépendre des autres.
...
def vincenty_direct(lat1_deg, lon1_deg, azimut1_deg, distance_m, a, f):
    ...
    route Garoupe→Monte Cinto (vérification du profil intermédiaire, Tableau 10, §12.3) — jamais
