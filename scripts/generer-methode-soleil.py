...
def corps(fr):
    ...
    if fr:
        ...
        A("<h3>X1.5 &#8212; Pourquoi deux stations simultan&#233;es</h3>")
        A("<p>Un rapport mesur&#233; depuis une seule station donne un profil de "
          "distance, jamais la distance elle-m&#234;me&#160;: il y faut une base. Et "
          "une station isol&#233;e ne s&#233;pare pas une source dont la distance ne "
          "varie pas d'une source dont la distance &#224; <em>chaque</em> observateur "
          "resterait constante par construction &#8212; une image form&#233;e par une "
          "couche atmosph&#233;rique, ou une projection propre &#224; l'&#339;il qui "
          "la regarde. Les deux pr&#233;disent la m&#234;me constance.</p>")
        ...
        A("<h3>X1.5 &#8212; Why two simultaneous stations</h3>")
        A("<p>A ratio measured from a single station gives a distance profile, never "
          "the distance itself: that requires a baseline. And a single station does not "
          "separate a source whose distance does not vary from one whose distance to "
          ...
          "beholds it. Both predict the same constancy.</p>")
